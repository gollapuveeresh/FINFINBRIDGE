...
const Navbar = () => {
  ...
  const whatWeAreLinks = [
    ...
    { name: "Why FinBridge", path: "/about#why" },
    { name: "Technology", path: "/digital-finance" },
    { name: "Healthcare", path: "/risk-compliance" },
    { name: "Manufacturing", path: "/valuation-advisory" },
    { name: "Retail", path: "/transaction-services" },
    { name: "Education", path: "/financial-transformation" },
    { name: "Financial Services", path: "/corporate-finance" }
  ];

  const whatWeDoLinks = [
    { name: "Financial Planning", path: "/financial-transformation" },
    ...
    { name: "Tax Planning", path: "/corporate-finance" },
    { name: "Tax Optimization", path: "/corporate-finance" },
    { name: "Compliance Management", path: "/risk-compliance" },
    { name: "Tax Reporting", path: "/corporate-finance" },
    { name: "Portfolio Analysis", path: "/wealth-management" },
    { name: "Wealth Planning", path: "/wealth-management" },
    { name: "Investment Strategy", path: "/wealth-management" },
    { name: "Risk Analysis", path: "/risk-compliance" },
    { name: "Investor Connect", path: "/transaction-services" },
    { name: "Funding Assistance", path: "/transaction-services" },
    { name: "Growth Capital", path: "/transaction-services" },
    { name: "Business Planning", path: "/corporate-finance" }
  ];

  const ourThinkingLinks = [
    { name: "Market Insights", path: "/market-intelligence" },
    { name: "Economic Outlook", path: "/market-intelligence" },
    { name: "Financial Trends", path: "/wealth-management" },
    { name: "Industry Reports", path: "/valuation-advisory" },
    { name: "Business Guides", path: "/corporate-finance" },
    { name: "Tax Strategies", path: "/corporate-finance" },
    { name: "Investment Resources", path: "/wealth-management" },
    { name: "Financial Planning", path: "/financial-transformation" },
    { name: "Startup Success Stories", path: "/transaction-services" },
    { name: "Funding Case Studies", path: "/transaction-services" },
    { name: "Client Transformations", path: "/financial-transformation" },
    { name: "Business Growth Stories", path: "/corporate-finance" },
    { name: "AI in Finance", path: "/digital-finance" },
    { name: "FinTech Trends", path: "/digital-finance" },
    { name: "Future of Finance", path: "/digital-finance" },
    { name: "Digital Transformation", path: "/digital-finance" }
  ];
