    ...
    <div className="min-h-screen bg-bg">
      ...
      <footer className="ml-[280px] py-6 px-margin-desktop bg-surface-hover-lowest flex flex-col md:flex-row justify-between items-center border-t border-border text-text-muted text-body-sm">
        ...
        <div className="flex gap-8 mt-3 md:mt-0">
          <Link to="/client/settings" className="hover:underline decoration-secondary transition-opacity">Privacy Policy</Link>
          <Link to="/client/settings" className="hover:underline decoration-secondary transition-opacity">Terms of Service</Link>
          <Link to="/client/help" className="hover:underline decoration-secondary transition-opacity">Contact Support</Link>
        </div>
      </footer>
    </div>
  );
