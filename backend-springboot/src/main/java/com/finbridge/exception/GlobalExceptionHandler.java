...
public class GlobalExceptionHandler {
        ...
        /**
         * Malformed/invalid request body (e.g. bad JSON, wrong field types) → 400, no
         * internals leaked.
         */
        ...
        /**
         * Catch-all: log full detail server-side, return an opaque message + reference
         * id to the client.
         */
        ...
        public ResponseEntity<Map<String, String>> handleGeneral(Exception ex) {
                ...
                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                .body(Map.of("status", "error",
                                                "message",
                                                "An unexpected error occurred. Please contact support with this reference.",
                                                "ref", ref));
        }
}
